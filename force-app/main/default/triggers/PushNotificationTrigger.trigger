trigger PushNotificationTrigger on Property__c (after insert,before update) {
    
    if( trigger.isBefore && trigger.isUpdate){
        system.assert(false,trigger.new[0].NumberOfOffers__c+'--->'+trigger.old[0].NumberOfOffers__c);
    }
    /*
